...
SECRET_KEY = "django-insecure-_9v5_$pi4@g@jn_84(m&-vd(+^x7y^_!wcid9aqp-w1z@wxjdw"
...
# Authentication with JWT & pagination
REST_FRAMEWORK = {
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/django.log'),  #stock logs here
            'maxBytes': 1024 * 1024 * 5,  # 5MB
            'backupCount': 3,  #keep 3 files max before running
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
    ...
    'loggers': {
        'django': {
            'handlers': ['file','console'],  #Logs to file and console
            'level': 'INFO',
            'propagate': False,
        },
    },
